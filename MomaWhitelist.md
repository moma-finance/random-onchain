# Moma whitelist random algorithm


You can run this on jsfiddle, dont forget fill the blockhash in line 24.
...
```js
/**
     * This is an random algorithm for choosing the whitlist addresses.
     *
    ...
    // ETH block height 12133159 hash (haven't mined)
    const ethHash = '';
